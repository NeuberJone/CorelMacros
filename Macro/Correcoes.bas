...
Sub RedimensionarEMoverObjetos()
    ...
    novoX = ConverterParaUnidadesDoCorel(x_cm)
    novoY = ConverterParaUnidadesDoCorel(y_cm)
...
Function ConverterParaUnidadesDoCorel(coordenada_cm As Double) As Double
    ' Fator de conversão (1 cm = 1 unidade no CorelDRAW)
    ConverterParaUnidadesDoCorel = coordenada_cm
End Function

...
Sub LinhaOuro()
    ...
    With ActiveLayer.Shapes(1).Fill.ApplyFountainFill(CreateCMYKColor(36, 51, 100, 18), CreateCMYKColor(36, 51, 100, 18), cdrLinearFountainFill, 0#, 0, 0, 50, cdrCustomFountainFillBlend).Colors
        .Add CreateCMYKColor(4, 29, 78, 0), 30
        .Add CreateCMYKColor(0, 15, 48, 0), 52
        .Add CreateCMYKColor(5, 29, 79, 0), 76
    End With
